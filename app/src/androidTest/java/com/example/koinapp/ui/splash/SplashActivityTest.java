...
public class SplashActivityTest {
    ...
    public void open_welcome_if_first_run() throws InterruptedException {
        prefs.edit().putBoolean(WelcomeActivity.KEY_WELCOME, true).apply();
    ...
    public void open_main_if_start_working_being_clicked() throws InterruptedException {
        prefs.edit().putBoolean(WelcomeActivity.KEY_WELCOME, false).apply();
        rule.launchActivity(new Intent());
        Intents.init();
    ...
    private static class TestIdling implements Idling {
